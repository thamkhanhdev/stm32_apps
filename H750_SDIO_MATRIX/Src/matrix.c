...
// uint16_t const gTimeCount[8]={ 70, 70, 70, 70, 70, 70, 70, 70}; // he so chia nap vao timer ok with 256x64 47.9Hz
uint16_t const gTimeCount[8]={ 30, 50, 90, 160, 240, 320, 480, 600}; // he so chia nap vao timer ok with 256x64 47.9Hz
// uint16_t const gTimeCount[8]={ 33, 60, 110, 180, 250, 320, 480, 600}; // he so chia nap vao timer ok with 256x64 47.9Hz
...
size_t MATRIX_Write( uint8_t c, MATRIX_FontTypes fontType )
{
    ...
    {
        if(c == '\n') {                        // Newline?
            gCursorX  = gBackupX;                     // Reset x to zero,
