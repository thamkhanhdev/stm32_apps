...
//     {
//             MATRIX_SetCursor(20, 5);
//             MATRIX_SetTextColor(0xF800);
//             MATRIX_Printf( FONT_DEFAULT, "Couldn't detect Card!\n");
...
//         {
//                 // MATRIX_FillRect(0, 0, 127, 8, 0x0);
//                 MATRIX_SetCursor(30, 5);
//                 MATRIX_SetTextColor(0xF800);
//                 MATRIX_Printf( FONT_DEFAULT, "4Bus Error!\n");
//                 MATRIX_SetTextColor(0xFFFF);
//         sd_state = MSD_ERROR;
//         }
//     }
//     else
//     {
//         MATRIX_Printf( FONT_DEFAULT, "HAL configured wrong!\n");
//     }
